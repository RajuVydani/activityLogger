...
public class TrackerService {
	...
	/**
	 * Stores Agent idle hours from extension. agentName, EmailId,
	 * (IdleHours)From, To, WebsitesUsed sampleUrl ::
	 * http://localhost:8082/TimeTracker/rest/agent/
	 * 
	 * @return
	...
	public Response storeAgentData(@PathParam("serviceName") String serviceName,
			@PathParam("agentName") String agentName, @PathParam("agentEmailId") String agentEmailId,
			@PathParam("productivityHours") String productivityHours, @PathParam("loginTime") String loginTime,
			@PathParam("logoutTime") String logoutTime, @PathParam("idleTimings") String idleTimings)
