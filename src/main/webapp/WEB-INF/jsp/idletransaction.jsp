...
<body>
					...
					.click(
							function() {
								...
								var emailid = document
										.getElementById("currentemailid").value;

								var fromDate = document
										.getElementById("fromdate").value;
								var toDate = document.getElementById("todate").value;
								window.location.href = "/TimeTrackerWeb/daytransaction?id="
										+ emailid
										+ "&fromdate="
										+ fromDate
										+ "&todate=" + toDate;
	...
	<spring:form>
		...
		<input type="hidden" name="currentemailid" id="currentemailid"
			value='${displayList.DefaultAgentEmailId}'>
		<input type="hidden" name="currentdate" id="currentdate"
			value='${displayList.DefaultCurrentDate}'>
		<input type="hidden" name="fromdate" id="fromdate"
			value='${displayList.DefaultFromDate}'>
		<input type="hidden" name="todate" id="todate"
			value='${displayList.DefaultToDate}'>
