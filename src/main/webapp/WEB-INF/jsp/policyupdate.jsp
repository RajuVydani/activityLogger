...
<body>
	...
	<spring:form modelAttribute="policyAtt" action="policyupdate"
		...
		<table border="0" align="left">
			<tr>
				...
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td><a href="/TimeTrackerWeb/">Logout</a></td>
			</tr>
		</table>
		<br>
		...
		<ul class="form-style-1">
			...
			<li><label>Policy Tagging<span class="required">*</span></label>
				<select name="PolicyTagging" class="field-select" required>
					<option value="Advertise">Advertise</option>
					<option value="Partnership">Partnership</option>
					<option value="General Question">General</option>
			</select></li>

			<li><label>Policy Updated On<span class="required">*</span></label><input
				type="date" name="policyUpdatedOn" class="field-divided" required /></li>
			<li>
			<li><label>Policy Content<span class="required">*</span></label>
				<textarea name="policyContent" class="field-long field-textarea"
