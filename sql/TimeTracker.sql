...
DROP TABLE IF EXISTS `CHROME_TEMP_DETAILS_BKP`;
...
DROP TABLE IF EXISTS `SUB_PROJECT_MASTER`;
...
`IDLE_SUM` float NOT NULL,
`PROD_AVG` float NOT NULL,
`IDLE_AVG` float NOT NULL,
`BREAK` float NOT NULL,
`MEALS` float NOT NULL,
`HUDDLE` float NOT NULL,
`WELLNESS_SUPPORT` float NOT NULL,
`COACHING` float NOT NULL,
`TEAM_MEETING` float NOT NULL,
`FB_TRAINING` float NOT NULL,
`NON_FB_TRAINING` float NOT NULL,
  ...
  PRIMARY KEY ( `AGENT_ID`,`MONTH`,`YEAR`)
...
CREATE TABLE `CHROME_IDLE_INTERVAL` (
  `INTERVAL_SECS` int(11) NOT NULL,
    ...
    `LOCATION_ID` varchar(25) NOT NULL,
    `SUB_PROJECT_ID` INT NOT NULL,
  PRIMARY KEY (`PROJECT_ID`,`LOCATION_ID`,  `SUB_PROJECT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `CHROME_TEMP_DETAILS_BKP` (
  `EMAIL_ID` varchar(50) NOT NULL,
  `FROM_TIME` datetime NOT NULL,
  `TO_TIME` datetime NOT NULL,
  `WEBSITE_USED` varchar(500),
...
CREATE TABLE `SHIFT_TIMINGS` (
  ...
  PRIMARY KEY (`PROJECT_ID`, `LOCATION_ID`,`SUB_PROJECT_ID`  , `SNO`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `USER_PRIVILEGES`(`USER_TYPE`,`PRIVILEGES_ID`,`VIEW_ONLY`,`PDF_EXPORT`,`CSV_EXPORT`,`EXCEL_EXPORT`,`PRINT`)
VALUES('Admin',0,'Yes','Yes','Yes','Yes','Yes');
INSERT INTO `USER_PRIVILEGES`(`USER_TYPE`,`PRIVILEGES_ID`,`VIEW_ONLY`,`PDF_EXPORT`,`CSV_EXPORT`,`EXCEL_EXPORT`,`PRINT`)
VALUES('Team Lead / Supervisor',10,'No','No','No','No','No');
INSERT INTO `USER_PRIVILEGES`(`USER_TYPE`,`PRIVILEGES_ID`,`VIEW_ONLY`,`PDF_EXPORT`,`CSV_EXPORT`,`EXCEL_EXPORT`,`PRINT`)
VALUES('Team Manager',20,'No','No','No','No','No');
INSERT INTO `USER_PRIVILEGES`(`USER_TYPE`,`PRIVILEGES_ID`,`VIEW_ONLY`,`PDF_EXPORT`,`CSV_EXPORT`,`EXCEL_EXPORT`,`PRINT`)
VALUES('Service Delivery Manager',30,'No','No','No','No','No');
INSERT INTO `USER_PRIVILEGES`(`USER_TYPE`,`PRIVILEGES_ID`,`VIEW_ONLY`,`PDF_EXPORT`,`CSV_EXPORT`,`EXCEL_EXPORT`,`PRINT`)
VALUES('Project Manager',40,'Yes','Yes','Yes','Yes','No');
INSERT INTO `USER_PRIVILEGES`(`USER_TYPE`,`PRIVILEGES_ID`,`VIEW_ONLY`,`PDF_EXPORT`,`CSV_EXPORT`,`EXCEL_EXPORT`,`PRINT`)
VALUES('Program Manager',50,'Yes','Yes','Yes','Yes','Yes');
INSERT INTO `USER_PRIVILEGES`(`USER_TYPE`,`PRIVILEGES_ID`,`VIEW_ONLY`,`PDF_EXPORT`,`CSV_EXPORT`,`EXCEL_EXPORT`,`PRINT`)
VALUES('Program User',60,'Yes','Yes','Yes','Yes','Yes');
INSERT INTO `USER_PRIVILEGES`(`USER_TYPE`,`PRIVILEGES_ID`,`VIEW_ONLY`,`PDF_EXPORT`,`CSV_EXPORT`,`EXCEL_EXPORT`,`PRINT`)
VALUES('Business User',70,'Yes','Yes','Yes','Yes','Yes');
INSERT INTO `USER_PRIVILEGES`(`USER_TYPE`,`PRIVILEGES_ID`,`VIEW_ONLY`,`PDF_EXPORT`,`CSV_EXPORT`,`EXCEL_EXPORT`,`PRINT`)
VALUES('Super Business User',80,'Yes','Yes','Yes','Yes','Yes');
INSERT INTO `USER_PRIVILEGES`(`USER_TYPE`,`PRIVILEGES_ID`,`VIEW_ONLY`,`PDF_EXPORT`,`CSV_EXPORT`,`EXCEL_EXPORT`,`PRINT`)
VALUES('Client',90,'Yes','Yes','Yes','Yes','Yes');
INSERT INTO `USER_PRIVILEGES`(`USER_TYPE`,`PRIVILEGES_ID`,`VIEW_ONLY`,`PDF_EXPORT`,`CSV_EXPORT`,`EXCEL_EXPORT`,`PRINT`)
VALUES('Guest',100,'Yes','No','No','No','No');
 ...
 CREATE TABLE `USER_DETAILS` (
  ...
  `FIELD3` varchar(5),
   ...
   CREATE TABLE `SUB_PROJECT_MASTER` (
  `SUB_PROJECT_ID` INT NOT NULL,
 ...
 `LOCATION_ID` varchar(30) NOT NULL,
  ...
  `FIELD2` varchar(5)   ,
  `FIELD3` varchar(5),
   PRIMARY KEY (  `TEAM_MANAGER_ID` ,`SUB_PROJECT_ID`)
);
 ...
 CREATE TABLE `PROJECT_HIERARCHY` (
  ...
  `PROJECT_ID` INT NOT NULL,
   `PROJECT_MANAGER_ID` varchar(50) NOT NULL,
           `PROJECT_MANAGER_NAME`varchar(30) NOT NULL,
   `LOCATION_ID` varchar(30) NOT NULL,
  `SUB_PROJECT_ID` INT NOT NULL,
  ...
  `FIELD2` varchar(5)   ,
  `FIELD3` varchar(5),
   PRIMARY KEY (  `PROGRAM_ID` ,`PROJECT_ID`,`LOCATION_ID`,`SUB_PROJECT_ID`)
);
