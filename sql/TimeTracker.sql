...
CREATE TABLE `AGENT_MASTER` (
  ...
  `HCM_SUPERVISOR_ID` varchar(50) NOT NULL,
...
CREATE TABLE `CHROME_TEMP_DETAILS` (
  ...
  `WEBSITE_USED` varchar(500) DEFAULT NULL,
  `ACTIVITY_CODE` varchar(10) NOT NULL,
  PRIMARY KEY (`EMAIL_ID`,`FROM_TIME`)
);
...
CREATE TABLE `PROGRAM_MASTER` (
  ...
  `SUB_PROJECT_ID` varchar(50),
    `SUB_PROJECT_NAME` varchar(50),
		 `SUB_PROJECT_DESC` varchar(50),
  `LOCATION_ID` varchar(50),
  `FIELD1` varchar(5)   ,
  `FIELD2` varchar(5)   ,
  `FIELD3` varchar(5),
   PRIMARY KEY (`PROGRAM_ID`,`PROJECT_ID`,  `SUB_PROJECT_ID`)
);

CREATE TABLE `PROGRAM_TRANSACTION` (
  `PROGRAM_ID` varchar(50) NOT NULL,
  `PROGRAM_NAME` varchar(50) NOT NULL,
  `PROGRAM_MANAGER_ID` varchar(50) NOT NULL,
...
CREATE TABLE `SUB_PROJECT_TRANSACTION` (
  `SUB_PROJECT_ID` varchar(50) NOT NULL,
  `SUB_PROJECT_NAME` varchar(50) NOT NULL,
  `SUPERVISOR_ID` varchar(50) NOT NULL,
  `SUPERVISOR_NAME` varchar(50) NOT NULL,
  `PROJECT_ID` varchar(50) NOT NULL,
  `SUB_PROJECT_DESC` varchar(70) NOT NULL,
  `LOCATION_ID` varchar(30) NOT NULL,
  `FIELD1` varchar(5)   ,
  `FIELD2` varchar(5)   ,
  `FIELD3` varchar(5),
   PRIMARY KEY (  `SUB_PROJECT_ID`,`PROJECT_ID`,`SUPERVISOR_ID`)
);
...
(`EMAIL_ID`,`AGENT_ID`,`AGENT_NAME`,`PROJECT_ID`,`PROJECT_NAME`,`SHIFT_TIMINGS`,`LOCATION`,`ALLOCATION_START_DT`,`ALLOCATION_END_DT`,`BILLABLE`,`ON_OFF`,`HCM_SUPERVISOR_ID`,`HCM_SUPERVISOR_NAME`)
VALUES
('raju.v@cognizant.com','581345','PrasadRaju','11113456','Time_Tracker','9PM-6AM','HYD','2017-03-01','2017-12-12','NBL','OFF','00001','Eswar'),
('selvamani.t@cognizant.com','597125','Selvamani','11113456','Test Project','9PM-6AM','CHN','2017-03-01','2017-12-12','NBL','OFF','00002','Ram Kumar'),
('avik.chattopadhyay@cognizant.com','613788','Avik','11113456','Test Project','9AM-6PM','HYD','2017-03-01','2017-12-12','NBL','OFF','00003','Rubesh'),
('Adeeb.Mohammed@cognizant.com','557869','Adeeb Mohammad','11113456','COMMERCE','9PM-6AM','HYD','2017-03-01','2017-12-12','NBL','OFF','00003','Rajeev Kumar'),
('SaiSharanchandra.Macharla@cognizant.com','546778','Sai Sharan Chandra','11113456','VIDEOS','3PM-12AM','HYD','2017-03-01','2017-12-12','NBL','OFF','00004','Usha'),
('Praveen.Potharaveni@cognizant.com','553684','Praveen Potharavaneni','11113456','VIDEOS','9PM-6AM','HYD','2017-03-01','2017-12-12','NBL','OFF','00005','Ravi Raju'),
('Jyothi.Keerthi@cognizant.com','559941','Keerthi Jyothi','11113456','VIDEOS','9PM-6AM','HYD','2017-03-01','2017-12-12','NBL','OFF','00006','Ravindra')
...
ON DAY_MASTER (EMAIL_ID,SHIFT_DETAILS,PROJECT_ID,LOCATION,HCM_SUPERVISOR_ID);
CREATE INDEX INDEX_DAY_DETAIL
ON DAY_DETAIL (EMAIL_ID,FROM_TIME,TO_TIME,ACTIVITY_CODE);